...
async function fillForm(fname, lname, admitted, graduate) {
  ...
  if (graduate) {
    formUrl = admitted ?
      "https://cdn.jsdelivr.net/gh/WildChickenUniversity/admission/assets/template_master.pdf" : "https://cdn.jsdelivr.net/gh/WildChickenUniversity/admission/assets/template_master_reject.pdf";
  } else {
    formUrl = admitted ?
      "https://cdn.jsdelivr.net/gh/WildChickenUniversity/admission/assets/template.pdf" : "https://cdn.jsdelivr.net/gh/WildChickenUniversity/admission/assets/template_reject.pdf";      
  }
